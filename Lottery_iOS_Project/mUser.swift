...
class mUser {
    ...
    init(dictionary: AnyObject) {
        ...
        let isAccepted_checking_notification:Int = (dictionary["isAccepted_checking_notification"] as? Int)!
        ...
        let isAccepted_lottery_notification:Int = (dictionary["isAccepted_lottery_notification"] as? Int)!
