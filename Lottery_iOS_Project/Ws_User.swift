...
//                print("================================================================")
                if let arrayOfDictionaries = jsonResult as? AnyObject {
                    globalProperty = mGlobalproperty(dictionary: arrayOfDictionaries )
    ...
    static func GetUserProfile(email: String,completion:(responseData:mUser,errorMessage:NSError?)->Void)
    {
        ...
        let task = NSURLSession.sharedSession().dataTaskWithURL(url!) {(data, response, error) in
            do {
                ...
                //                print("================================================================")
                if let arrayOfDictionaries = jsonResult as? AnyObject {
                    userProfile = mUser(dictionary: arrayOfDictionaries )
    ...
    // UpdateUserProfile
    static func UpdateUserProfile(email: String,password: String,name: String,birthday: String,gender: String,
    ...
    // GetUserLottery
    static func GetUserLottery(user_id: Int64, completion:(responseData:[mUserLottery],errorMessage:NSError?)->Void)
    {
    ...
    // AddUserLottery
    static func AddUserLottery(user_id: Int64,numbers: String,period_lottery_date: String,
                               completion:(responseData:[mUserLottery],errorMessage:NSError?)->Void)
    {
        var userLottery:[mUserLottery]!
    ...
    // DeleteUserLottery
    static func DeleteUserLottery(user_id: Int64,userLottery_id: Int64,
                               completion:(responseData:[mUserLottery],errorMessage:NSError?)->Void)
    {
        var userLottery:[mUserLottery]!
    ...
    static func UpdateCheckingNotification(user_id: String,isAccepted: String,completion:(responseData:mMessageResponse,errorMessage:NSError?)->Void)
    {
        var messageResponse:mMessageResponse!
        let url = NSURL(string: "http://tskyonline.com:83/Ws_User/UpdateCheckingNotification?user_id=" + String(user_id) + "&isAccepted=" + isAccepted)
    ...
    // UpdateCheckingNotification
    static func UpdateGetNewLotteryNotification(user_id: String,isAccepted: String,completion:(responseData:mMessageResponse,errorMessage:NSError?)->Void)
    {
        var messageResponse:mMessageResponse!
        let url = NSURL(string: "http://tskyonline.com:83/Ws_User/UpdateGetNewLotteryNotification?user_id=" + String(user_id) + "&isAccepted=" + isAccepted)
